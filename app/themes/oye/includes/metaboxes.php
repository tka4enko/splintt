...
if (($template_file == "pages/page-overzicht-e-learning.php")) {
    $meta_boxes[] = array(
        'id' => 'oye_box_title',
        'title' => __('Box Title', ''),
        'pages' => array('page'),
...
if (($template_file == "pages/page-overzicht-leerplatform.php")) {
    $meta_boxes[] = array(
        'id' => 'oye_box_title',
        'title' => __('Box Title', ''),
        'pages' => array('page'),
...
if (($template_file == "pages/page-overzicht-e-learning.php") || ($template_file == "pages/page-overzicht-leerplatform.php") || ($template_file == "pages/page-nieuws.php")) {
    $meta_boxes[] = array(
...
$meta_boxes[] = array(
    ...
    'fields' => array(
        ...
        // array(
        //     'name' => __('Korte title', ''),
        //     'id' => "{$oyeprefix}vacature_kortetitle",
        //     'type' => 'text',
        //     'desc' => __(''),
        // ),
        array(
...
$meta_boxes[] = array(
    ...
    // array(
    //     'name' => __('Btn Bg Color', ''),
    //     'id' => "{$oyeprefix}btn_bg_color",
    //     'type' => 'text',
    //     'desc' => __(''),
    // ),
    )
...
if( $template_file == "pages/page-landingspage.php" ){
	$meta_boxes[] = array(
		'id' => 'page_featured_blocks',
		'title' => __('Featured blocks', ''),
		'pages' => array( 'page' ),
		'context' => 'normal',
		'priority' => 'high',
		'fields' => array(
...
if (($template_file == "pages/page-blog.php") || ($template_file == "pages/page-werken-bij.php")) {
    $meta_boxes[] = array(
...
if (($template_file == "pages/page-portfolio.php") || ($template_file == "pages/page-overzicht-e-learning.php") || ($template_file == "pages/page-overzicht-leerplatform.php")) {
    $meta_boxes[] = array(
...
if (($template_file == "pages/page-werken-bij.php")) {
    $meta_boxes[] = array(
...
//            array(
//                'name' => __('Homepage Blog Post Left Color', ''),
//                'desc' => __(''),
//                'id' => "homepage_blog_posts_left_color",
//                'type' => 'text'
//            ),
//            array(
//                'name' => __('Homepage Blog Posts Right Color', ''),
//                'desc' => __(''),
//                'id' => "homepage_blog_posts_right_color",
//                'type' => 'text'
//            ),
        )
    );
...
// if (($template_file == "pages/page-portfolio.php")) {
//     $meta_boxes[] = array(
//         'id' => 'portfolio_overview_fields',
//         'title' => __('Portfolio Overview Fields', ''),
//         'pages' => array('page'),
//         'context' => 'normal', // Where the meta box appear: normal (default), advanced, side. Optional.
//         'priority' => 'high',
//         'fields' => array(
//             array(
//                 'name' => __('Portfolio Overview Title', ''),
//                 'desc' => __(''),
//                 'id' => "portfolio_overview_title",
//                 'type' => 'text'
//             ),
//             array(
//                 'name' => __('Portfolio Overview Subtitle', ''),
//                 'desc' => __(''),
//                 'id' => "portfolio_overview_subtitle",
//                 'type' => 'text'
//             ),
//             array(
//                 'name' => __('Portfolio Overview Header Image', ''),
//                 'id' => "portfolio_overview_header_image",
//                 'type' => 'image_advanced',
//                 'max_file_uploads' => 1,
//                 'desc' => __(''),
//             ),
...
if (($template_file == "pages/page-contact.php")) {
    $meta_boxes[] = array(
...
if (($template_file == "pages/page-wij-zijn-de-splinters.php")) {
    $meta_boxes[] = array(
        'id' => 'about_us_fields',
...
if (($template_file == "pages/page-demo.php")) {
    $meta_boxes[] = array(
